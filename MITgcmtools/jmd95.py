...
# Copied and modified (syntax) by pascalb on 2018-12-18
# Also removed useless np.asfarray calls (multiplication always keeps the most precise type in Py3)
# Copied so we don't have to add MITgcmutils as dependency
"""
...
def densjmd95(s, t, p):
   ...
   =========================================================================
    ...
    if np.any(s < 0):
        warn('Negative salinity values! Setting to nan.')
